...
app.post('/register', async (req, res) => {
  ...
  // Clean console logging for production readiness
  console.log(`Received Cognito registration request for username: ${username}, email: ${email}`);

  // Setup Cognito SignUp parameters
  const params = {
    ClientId: "", // Found in Cognito Console -> App integrations
    Username: username,
    Password: password,
    UserAttributes: [
      {
  ...
  try {
    ...
    console.log("Cognito user registration successful:", response.UserSub);

    // success: true indicates the user was created and a verification email was sent
    res.json({ 
      success: true, 
      message: "Registration successful. Please check your email for a verification code.",
      userSub: response.UserSub // This is the unique ID generated by Cognito
    });

  } catch (err) {
    console.error("Cognito registration error:", err);

    // Handle specific Cognito error types gracefully
