This is a cloud-based project that involves hosting a photo-uploading web application on a virtual server (Amazon EC2) on the AWS Cloud platform. The website allows users to upload photos, which are stored in an Amazon S3 storage bucket.
